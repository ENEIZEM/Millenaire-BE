...
const NORMAN = Translation.addTranslation("norman");
const INDIAN = Translation.addTranslation("indian");
const MAYAN = Translation.addTranslation("mayan");
const JAPANESE = Translation.addTranslation("japanese");
const BYZANTINES = Translation.addTranslation("byzantines");
const INUITS = Translation.addTranslation("inuits");
const SELJUK = Translation.addTranslation("seljuk");
